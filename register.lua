    ...
    on_fire = function(itemstack, user, bullet_entity)
      ...
      for i=1, b_def.shots do
        local obj = core.add_entity(pos, "bestguns:bullet", core.serialize({
            velocity = vector.offset(bullet_vel, bestguns.r(35), bestguns.r(35), bestguns.r(35)),
...
--[[
local ctf = core.get_game_info().id == "capturetheflag"
if ctf then
  core.register_on_mods_loaded(function()
    core.unregister_item("ctf_ranged:pistol_loaded")
    core.register_alias("ctf_ranged:pistol_loaded", "bestguns:pistol")
    core.unregister_item("ctf_ranged:rifle_loaded")
    core.register_alias("ctf_ranged:rifle_loaded", "bestguns:assault_rifle")
    core.unregister_item("ctf_grenades:smoke")
    core.register_alias("ctf_grenades:smoke", "bestguns:shotgun")
